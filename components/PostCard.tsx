...
export default function PostCard({ post, featured = false }: Props) {
  ...
  if (featured) {
    return (
      <Link href={`/posts/${post.slug}`}>
        <div className="group rounded-xl border border-slate-200 dark:border-white/[0.06] bg-white dark:bg-[#171b23] hover:border-slate-300 dark:hover:border-white/[0.1] hover:bg-slate-50 dark:hover:bg-[#1a202a] transition-all p-6">
  ...
  return (
    <Link href={`/posts/${post.slug}`}>
      <div className="group h-full rounded-xl border border-slate-200 dark:border-white/[0.06] bg-white dark:bg-[#171b23] hover:border-slate-300 dark:hover:border-white/[0.1] hover:bg-slate-50 dark:hover:bg-[#1a202a] transition-all p-4">
