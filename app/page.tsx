...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16">
      {/* Hero */}
      <section>
        <div className="mb-2 text-xs font-semibold text-emerald-400 uppercase tracking-widest">
          Mintlab
        </div>
        <h1 className="text-3xl font-bold text-slate-100 mb-3 leading-tight">
          직접 만들고, 깨지고,<br />
          <span className="text-emerald-400">고친 것들의 기록</span>
        </h1>
      ...
      {featured && (
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/posts" className="text-xs text-emerald-400 flex items-center gap-1 hover:underline">
      ...
      {guides.length > 0 && (
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/posts?category=guide" className="text-xs text-emerald-400 flex items-center gap-1 hover:underline">
      ...
      {tools.length > 0 && (
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/tools" className="text-xs text-emerald-400 flex items-center gap-1 hover:underline">
              더 보기 <ArrowRight size={12} />
            </Link>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
